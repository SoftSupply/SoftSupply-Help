    ...
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            bundles.Add(new StyleBundle("~/styles/bootstrap").Include(
                "~/components/bootstrap/dist/css/bootstrap.css", cssTransform));
            ...
            bundles.Add(new ScriptBundle("~/scripts/modernizr").Include(
                "~/components/modernizr/modernizr-*"));

            bundles.Add(new ScriptBundle("~/scripts/bootstrap").Include(
                "~/components/bootstrap/dist/js/bootstrap.js"));
            
            bundles.Add(new ScriptBundle("~/scripts/lightbox").Include(
               "~/components/lightbox2/dist/js/lightbox.js"));

            bundles.Add(new ScriptBundle("~/scripts/holder").Include(
               "~/components/holderjs/holder.js"));

            bundles.Add(new ScriptBundle("~/scripts/default").Include(
               "~/content/js/default.js",
               "~/content/js/default.cd-top.js"));
